...
const AboutTextCard = () => {
    return (
        <div className='h-full w-full md:w-1/2 font-body'>
            ...
            <div className="flex flex-col md:flex-row mx-2 my-4 gap-6">
                <button className='w-full md:w-auto bg-violet-700 text-white rounded-xl px-2 py-1 cursor-pointer'>
                    Download Resume
                ...
                <button
                    ...
                    className='w-full md:w-auto border-2 border-violet-700 rounded-xl px-2 py-1 cursor-pointer'
                >
                    Contact Me
            ...
            <div className='flex gap-6 m-2 p-2 scroll-mt-48' id='contact'>
                ...
                <a
                    href="https://www.linkedin.com/in/samoon-haider-320672267/"
                    target='_blank'
                >
                    <img
                        className='h-8 rounded-full'
                ...
                <a
                    href='https://mail.google.com/mail/?view=cm&fs=1&to=zshamoonhaider@gmail.com'
                    target='_blank'
                >
                    <img
                        className='h-8 rounded-full'
                ...
                <a
                    href="https://www.geeksforgeeks.org/profile/zshamoonhaider?tab=activity"
                    target='_blank'
                >
                    <img
                        className='h-8 rounded-full'
